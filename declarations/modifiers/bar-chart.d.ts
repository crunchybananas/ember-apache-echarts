...
export default class BarChartModifier extends AbstractChartModifier {
    ...
    isGroupedVariant(variant: Variant): boolean;
    isStackedVariant(variant: Variant): boolean;
    isBarVariant(variant: Variant): boolean;
    isAreaVariant(variant: Variant): boolean;
    /**
     ...
     */
    addTitle(context: any, config: any): {
        height: number;
        y: any;
        chartWidth: number;
        chartHeight: number;
     ...
     */
    computeCategoryAxisTicks(context: any, categoryInfo: any, axisConfig: any): ({
        position: number;
     ...
     */
    generateTextOverlayConfig(series: any, args: any, layout: any, style: any): (echarts.EChartsCoreOption & {
        graphic?: {
            'graphic.elements': {
                type: string;
                top: number;
