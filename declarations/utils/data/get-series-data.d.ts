 ...
 */
export default function getSeriesData(data: Data[], categories: string[], categoryProperty: string, valueProperty: string): any;
export {};
//# sourceMappingURL=get-series-data.d.ts.map