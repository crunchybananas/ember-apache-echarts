 ...
 */
export default function getSeriesTotals(data: DataItem[], categories: string[], categoryProperty: string, valueProperty: string): unknown[];
export {};
//# sourceMappingURL=get-series-totals.d.ts.map