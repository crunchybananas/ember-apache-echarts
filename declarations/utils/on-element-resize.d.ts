 ...
 */
export default function onElementResize(element: HTMLElement, callback: (element: HTMLElement) => void, onceOnly?: boolean): ResizeObserver;
//# sourceMappingURL=on-element-resize.d.ts.map