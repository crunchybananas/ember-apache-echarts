...
const numberRegEx = /^\d+$/;
const isNumeric = value => typeof value === 'number' || typeof value === 'string' && value.match(numberRegEx) != null;
...
var cssSize = helper(function cssSize(positional) {
  const size = positional[0] != null && positional[0] !== '' ? positional[0] : positional[1];
  return isNumeric(size) || size === '' ? size?.toString() !== '0' ? `${size}px` : '0' : `${size ?? '0'}`;
});

export { cssSize as default };
//# sourceMappingURL=css-size.js.map
