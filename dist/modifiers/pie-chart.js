...
import { TooltipComponent, TitleComponent, LegendComponent, GridComponent, DataZoomComponent, GraphicComponent } from 'echarts/components';
import { CanvasRenderer } from 'echarts/renderers';
import { use } from 'echarts/core';

use([CanvasRenderer, PieChart, TooltipComponent, TitleComponent, LegendComponent, GridComponent, DataZoomComponent, GraphicComponent]);
/**
 ...
 */
class PieChartModifier extends AbstractChartModifier {
  ...
  generatePlotConfig(series, layout, context) {
    ...
    return (!series.data || series.data.length == 0) && noDataText ? undefined : {
      series: [{
        type: 'pie',
        ...(variant === 'donut' && {
          radius: [layout.innerHeight * 0.3 / 2, layout.innerHeight * 0.7 / 2]
        }),
        center: [layout.innerX + layout.innerWidth / 2 - 0.5, layout.innerY + layout.innerHeight / 2 - 0.5],
...
export { PieChartModifier as default };
