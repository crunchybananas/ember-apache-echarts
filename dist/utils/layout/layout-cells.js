...
import resolveStyle from '../style/resolve-style.js';
...
function computeCellLayoutInfo(context, chart) {
  ...
  layoutSize = {
    width: layoutSize.width - cell.marginLeft - cell.marginRight - cell.borderLeftWidth - cell.borderRightWidth,
    height: layoutSize.height - cell.marginTop - cell.marginBottom - cell.borderTopWidth - cell.borderBottomWidth
  };
  Object.assign(cell, pickBy(resolveStyle(context.styles.cell, layoutSize), (_value, key) => key.startsWith('padding')));
 ...
 */
// @ts-expect-error: not sure
function layoutCells(context, array, callback) {
  ...
  return array.map((element, index) => {
    ...
    return callback(element, {
      ...
      x,
      y,
      innerX: x + layoutInfo.cell.marginLeft + layoutInfo.cell.borderLeftWidth + layoutInfo.cell.paddingLeft,
      innerY: y + layoutInfo.cell.marginTop + layoutInfo.cell.borderTopWidth + layoutInfo.cell.paddingTop + yOffset
    }, layoutInfo.chart, array);
  });
}

export { layoutCells as default };
//# sourceMappingURL=layout-cells.js.map
